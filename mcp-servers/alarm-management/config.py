...
class Settings(BaseSettings):
    ...
    alarm_api_base_url: str = Field(alias="ALARM_API_BASE_URL")
    alarm_api_token: str = Field(alias="ALARM_API_TOKEN")
    request_timeout_seconds: float = Field(default=5.0, alias="ALARM_API_TIMEOUT_SECONDS")
    max_retries: int = Field(default=3, alias="ALARM_API_MAX_RETRIES")
